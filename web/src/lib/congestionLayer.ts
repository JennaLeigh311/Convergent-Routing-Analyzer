...
// recipe used by the six-up MiniCongestionMap tiles. Centralizing it here keeps the
// load-bearing invariant in ONE place: immutable `data` (the static geometry table),
// color joined to live
